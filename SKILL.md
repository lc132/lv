...
**步骤10A — 全市场行情拉取**（v6.6.4重写：按成交额分页+数据量门控+自动降级）：
...
def fetch_all_a_stocks():
    ...
    try:
        ...
        params = {
            "pn": "1", "pz": "6000", "po": "0", "np": "1",  # v6.6.4: 降序
            "ut": "bd1d9ddb04089700cf9c27f6f7426281",
            "fltt": "2", "invt": "2", "fid": "f6",  # v6.6.4: 按成交额降序
            "fs": "m:0+t:6,m:0+t:80,m:1+t:2,m:1+t:23,m:0+t:81+s:2048",
            "fields": "f2,f3,f5,f7,f8,f10,f12,f14,f15,f16,f17,f18,f20,f62,f100,f102"  # v6.6.5: f100=行业,f102=板块,
...
**步骤10B — 板块/行业补全**（v6.6.5重写：三层策略，替代原WebSearch逐只补全）：
...
- **步骤10A 全市场API拉取**：通过东方财富clist API按成交额(fid=f6)降序分页拉取全A股行情(pn=1..60, pz=100)，返回量<500时自动降级新浪批量API。
- **步骤10B 板块/行业补全**：三层策略——clist已含f100/f102→直接使用,轻量clist行业API批量查询,名称关键词正则推断兜底（26组行业规则）。
