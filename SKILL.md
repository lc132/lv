...
- **步骤20B 生成HTML报告**：基于筛选结果生成自包含HTML报告（含筛选管道、推荐标的表、ECharts可视化图表、系统告警、策略说明），输出到 `/workspace/ashare-screening-YYYYMMDD/` 目录。HTML报告与Excel同步推送至GitHub。
