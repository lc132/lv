...
_INDUSTRY_PATTERNS = [
    ...
    (r'保险|人寿|平安(?!银行)', '非银金融'),
    (r'证券|券商|民生(?!银行)', '非银金融'),
    (r'铝业|铜业|有色|黄金|稀土|钢铁|矿业|钨业|钼业|钛业|镁业|锌业|锆业', '有色金属'),
    (r'煤炭|煤业|能源(?!新)', '煤炭'),
    (r'石油|石化|油田|海油', '石油石化'),
    (r'汽车|客车|摩托|动力(?!电池)|电驱', '汽车'),
    (r'电力|电网|核电|水电|风电|光伏|太阳能|新能源(?!汽车)|新能', '电力设备'),
    (r'化工|化学|化肥|农药|塑料|橡胶|化纤|涂料|索普', '基础化工'),
    (r'制药|医药|药业|生物|医疗|器械|疫苗|酵母', '医药生物'),
    (r'电子|半导体|芯片|集成|电路|光电|微电子|宏昌', '电子'),
    (r'软件|信息|科技|数据|网络|通信|互联|智能|数字|恒通', '计算机'),
    (r'食品|饮料|乳业|酒|啤酒|白酒|调味|零食|农产品|养殖|饲料|渔业|牧原|温氏', '食品饮料'),
    (r'地产|房产|物业|园区|城建', '房地产'),
    (r'建筑|建材|水泥|玻璃|工程|基建|路桥|钢构|雨虹', '建筑装饰'),
    (r'军工|航空|航天|船舶|兵器|卫星|导弹|红箭|兵装|中兵|光启', '国防军工'),
    (r'机场|航空(?!航天)|港口|航运|物流|高速|铁路|地铁|运输|中远|上港|东航', '交通运输'),
    (r'中免|免税|百货|零售|超市|商业|连锁|贸易|五矿', '商贸零售'),
    (r'传媒|影视|出版|广电|广告|游戏|文化|教育|娱乐|体育|三七', '传媒'),
